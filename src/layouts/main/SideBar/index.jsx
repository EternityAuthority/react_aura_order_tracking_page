...
export default function SideBarDrawer() {
  ...
  const idHash = "c4a46ef6a4764d49971408708ce82d83";

  const [orderData, setOrder] = useState('');
  useEffect(() => {
    getOrderDetails(idHash).then((order) => {
      setOrder(order);
          ...
          <Box display="flex" justifyContent="space-evenly">
            <Box>
              ...
              <Typography
                ...
                mb="25px"
              >
                {orderData && orderData.shipping.phone}
              </Typography>
              <Typography
                fontSize={isDesktop ? "12px" : "10px"}
                color="rgba(51, 51, 51, 0.5)"
              ...
              >
                {orderData && orderData.shipping.address.line1}
                {orderData && orderData.shipping.address.line2}
                {orderData && orderData.shipping.address.state}&nbsp;
                {orderData && orderData.shipping.address.postal_code}&nbsp;
                {orderData && orderData.shipping.address.city}&nbsp;
                {orderData && orderData.shipping.address.country}
              </Typography>
              <Typography
                fontSize={isDesktop ? "12px" : "10px"}
                color="rgba(51, 51, 51, 0.5)"
